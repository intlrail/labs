...
Tunnel.prototype.createMesh = function() {
  ...
  this.tubeMaterial = new THREE.MeshStandardMaterial({
    side: THREE.BackSide,
    map: textures.grill.texture,
    bumpMap: textures.grillBump.texture,
    bumpScale: 0.006
  });
  
  // Add two lights in the scene
  // An hemisphere light, to add different light from sky and ground
  var light = new THREE.HemisphereLight( 0xc0c0c0, 0xaaa9ad, 0.684);
...
var textures = {
  "grill": {
    url: "img/demo1/grillPattern8.jpg"
  },
  "grillBump": {
    url: "img/demo1/grillPattern8bump.png"
  }
};
// Create a new loader
