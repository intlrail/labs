  ...
  window.Terrain = (function() {
    class Terrain {
      ...
      initGUI() {
        ...
        this.gui.values.segments = this.gui.add(this.options, 'segments', 0, 10000).step(100);
        this.gui.values.perlin_passes = this.gui.add(this.options, 'perlin_passes', 1, 3).step(0.01);
        this.gui.values.elevation = this.gui.add(this.options, 'elevation', -10, 10).step(0.1);
        this.gui.values.noise_range = this.gui.add(this.options, 'noise_range', -2, 2).step(0.1);
