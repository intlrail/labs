...
(function (factory) {
  ...
  {
    name: 'intlrail',
    colors: ['#f2f2f7', '#bcbcc0', '#8e8e93', '#bcbcc0'],
    background: '#000',
    stroke: '#222'
  }]
  ...
  function ui(opts, full_reset, redraw, print) {
    ...
    f0.add(opts, 'cubedimZ', 0, 100, 1)
      .name('Z Dimension')
      .onChange(full_reset);
    f0.add(opts, 'outerSize', 0, 100, 1)
      .name('Section Sizes')
      .onChange(full_reset);
    f0.add(opts, 'minGridSize', 0, 100, 1)
      .name('Min Grid Size')
      .onChange(full_reset);
    f0.add(opts, 'innerSize', 0, 100, 1)
      .name('Atom Sizes')
      .onChange(full_reset);
    ...
    f1.add(opts, 'ty', -1000, 1000, 1)
      .name('Translate Y')
      .onChange(redraw);
    f1.add(opts, 'mag', 0, 100, 1)
      .name('Cell Size')
      .onChange(redraw);
    f1.add(opts, 'depthDim', 0, 100, 1)
      .name('Depth')
      .onChange(redraw);
    f1.add(opts, 'perspective', 0, 100, 0.1)
      .name('Perspective')
      .onChange(redraw);
