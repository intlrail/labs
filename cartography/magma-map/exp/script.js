...

{
	...
	class Particle {
		constructor() {
			...
			this.damp = 0.0002; // remember a very small amount of the last direction
			this.accel = 10000; // move very quickly
			this.init();
		}
		init() {
	...
	const particles = Array.from({ length: 40e0 }, () => new Particle());
	canvas.reset();
