...
var intlrail = [{
    name: 'intlrail',
    colors: ['#1c1c1e', '#2b2b2b', '#242426', '#2c2c2e', '#363638', '#3a3a3c', '#444446',
  ...
  function ui(opts, full_reset, redraw, print) {
    ...
    f0.open();
    f0.add(opts, 'cubedimX', 0, 100, 1)
      .name('X Dimension')
      .onChange(full_reset);
    f0.add(opts, 'cubedimY', 0, 100, 1)
      .name('Y Dimension')
      .onChange(full_reset);
    f0.add(opts, 'cubedimZ', 0, 100, 1)
      .name('Z Dimension')
      .onChange(full_reset);
    f0.add(opts, 'outerSize', 0, 100, 0.5)
      .name('Section Sizes')
      .onChange(full_reset);
    f0.add(opts, 'minGridSize', 0, 100, 0.5)
      .name('Min Grid Size')
      .onChange(full_reset);
    f0.add(opts, 'innerSize', 0, 100, 0.5)
      .name('Atom Sizes')
      .onChange(full_reset);
    ...
    f1.open();
    f1.add(opts, 'tx', -1000, 1000, 1)
      .name('Translate X')
      .onChange(redraw);
    f1.add(opts, 'ty', -1000, 1000, 1)
      .name('Translate Y')
      .onChange(redraw);
    f1.add(opts, 'mag', 0, 100, 0.1)
      .name('Cell Size')
      .onChange(redraw);
    f1.add(opts, 'depthDim', 0, 100, 0.01)
      .name('Depth')
      .onChange(redraw);
    f1.add(opts, 'perspective', 0, 100, 0.001)
      .name('Perspective')
      .onChange(redraw);
    ...
    f1.add(opts, 'shadeOpacity', 0, 255, 1)
      .name('Shade Opacity')
      .onChange(redraw);
    f1.add(opts, 'outerStrokeWeight', 0, 5, 0.1)
      .name('Outer Stroke Weight')
      .onChange(redraw);
    f1.add(opts, 'innerStrokeWeight', 0, 5, 0.1)
