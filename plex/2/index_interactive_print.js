(function (factory) {
  ...
  var intlrail = [
    {
      ...
      '#6c6c70', '#7c7c80', '#8e8e8e', '#8e8e93', '#aeaeb2',
      '#aeaeb2', '#bcbcc0', '#c7c7cc', '#d1d1d6', '#d8d8dc', 
      '#e5e5ea', '#ebebf0', '#f2f2f7'],
      stroke: '#ffffff',
      background: '#000000'
    }
  ];
  ...
  function ui (opts, full_reset, redraw, print) {
    ...
    f0.open();
    f0.add(opts, 'cubedimX', 0, 70, 1).name('X Dimension').onChange(full_reset);
    f0.add(opts, 'cubedimY', 0, 70, 1).name('Y Dimension').onChange(full_reset);
    f0.add(opts, 'cubedimZ', 0, 70, 1).name('Z Dimension').onChange(full_reset);
    f0.add(opts, 'outerSize', 0.1, 10, 0.01).name('Section Sizes').onChange(full_reset);
    f0.add(opts, 'minGridSize', 0.1, 10, 1).name('Min Grid Size').onChange(full_reset);
    f0.add(opts, 'innerSize', 0.1, 10, 0.01).name('Atom Sizes').onChange(full_reset);
    ...
    f1.add(opts, 'mag', 1, 30, 0.1).name('Cell Size').onChange(redraw);
    ...
    const shiftController = f1
      .add(opts, 'paletteShift', 0, 10, 0.1)
      .listen()
      .name('Palette Shift')
      .onChange(redraw);
    ...
    f1.add(opts, 'shadeOpacityFront', 0, 1, 0.05).name('Shade Opacity Front').onChange(redraw);
    f1.add(opts, 'shadeOpacityLeft', 0, 1, 0.05).name('Shade Opacity Left').onChange(redraw);
    f1.add(opts, 'shadeOpacityTop', 0, 1, 0.05).name('Shade Opacity Top').onChange(redraw);
    f1.add(opts, 'outerStrokeWeight', 0, 9, 0.05).name('Outer Stroke Weight').onChange(redraw);
    f1.add(opts, 'innerStrokeWeight', 0, 9, 0.05).name('Inner Stroke Weight').onChange(redraw);
