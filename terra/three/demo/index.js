...
var camera, scene, renderer, clock, player, terrainScene, decoScene, lastOptions, controls = {},
    fpsCamera, skyDome, skyLight, sand, water; // jscs:ignore requireLineBreakAfterVariableAssignment
...
function setupDatGui() {
    ...
    function Settings() {
        ...
        var gray = new THREE.MeshPhongMaterial({ color: 0x88aaaa, specular: 0x444455, shininess: 1 });
        var blend;
