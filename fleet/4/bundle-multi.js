(function (global, factory) {
  ...
  const sketch = p => {
    ...
    const number_of_apparata = 144;
    const scale = 0.5;
    const shuffle = 300;
    let tick = 0;
    const final_frame_duration = 60;
    ...
    p.keyPressed = () => {
      ...
      else if (p.keyCode === 80) p.saveCanvas('intlrail_assembly', 'png');
    };
  };
