...
const SVG = opt => {
	...
	const initSVG = opt => {
		...
		outside.setAttribute(
			"style",
			`fill:none;stroke:${opt.stroke || "#ffffff"};stroke-width:0.3;`
		);
		...
		saveText.setAttribute("style", `fill:none;stroke:${opt.stroke || "#ffffff"};stroke-width:0.3;opacity:1`);
